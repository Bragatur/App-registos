...
import { ChartBarIcon, LayoutDashboardIcon, LogOutIcon } from './icons';
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="sm:hidden flex items-center gap-2 bg-slate-100 p-1 rounded-lg mb-4 justify-center">
            <NavButton onClick={() => setView('dashboard')} isActive={currentView === 'dashboard'}>
                <LayoutDashboardIcon className="w-5 h-5" />
                <span>Registo</span>
            </NavButton>
